...
SIMpars.add_argument('--init', dest='T_init', metavar='<val>', type=float, default=200., help='Initialization time: only relaxation of the vertex model (float). Default: 200.')
...
SIMpars.add_argument('-s', dest='size', metavar=('<nX>','<nY>'), type=int, nargs=2, default=(40,10), help='Initial tissue size (width and height) in cell numbers. Default: (40 10)')
