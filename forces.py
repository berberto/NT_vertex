...
class TargetArea(Force):
    ...
    def force(self, cells):
        ...
        G.
        Speculation.
        The ith component of this looks like the area force on the root vertex of 
        edge i, in the direction of edge i's line segment.
...
class Tension(Force): #DID NOT WORK ON MAC
    r"""
...
class Pressure(Force): #DOESN'T WORK ON MAC
    r"""
...
#by_face seems to work on the mac but by_edge does not.
